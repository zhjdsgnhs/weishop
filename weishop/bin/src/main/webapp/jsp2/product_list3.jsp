  ...
  <ul>
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/g1.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">金丝莉 哇喔羊毛暖袖被JB-1050
</a>
     </h2>
     <p>
      <del>5.90</del>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/g2.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">金丝莉 初棉毛巾被
JB-1026</a>
     </h2>
     <p>
      <del>12.90</del>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/g3.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">金丝莉 百变多功能毯
JT-736A</a>
     </h2>
     <p>
      <del>9.90</del>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/g4.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">金丝莉 蚕丝贡棉套件
流行风--蓝
</a>
     </h2>
     <p>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/g5.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">维科 全棉羽绒被
VKM-161831</a>
     </h2>
     <p>
      <del>9.90</del>
