		...
		<div class="modal-body">		
			<table class="table table-bordered table-striped"  width="800px">
		     	...
		     	<td><input  type="text" value="${firstChar}" name="firstChar" id="firstChar" class="form-control" placeholder="首字母" >   </td>
		      		...
		      		<tr>
		      		<td>发布人</td>
		     	<td><input  type="text" value="${publish}" name="publish" id="publish" class="form-control" placeholder="发布人" >   </td>
		      	</tr>
		      		<tr>
		      		<td>发布时间</td>
		     	<td>
		     	<input  type="text" value="${publishTime}" name="publishTime" id="publishTime" class="form-control" placeholder="发布时间" >
