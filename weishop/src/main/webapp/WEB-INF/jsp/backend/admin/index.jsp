    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index" class="logo">
                ...
                <span class="logo-mini"><b>微商城</b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>微商城-运营商后台</b></span>
            </a>
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="${pageContext.request.contextPath }/statics/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Developers
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu"  >
                    ...
                    <li id="admin-index"><a href="login"><i class="fa fa-dashboard"></i> <span>首页</span></a></li>
				    ...
				    <li class="treeview">
				        ...
				        <ul class="treeview-menu">
				            ...
				            <li id="admin-login">
				                <a href="${pageContext.request.contextPath }/WEB-INF/jsp/backend/admin/seller_1.jsp" target="iframe">
