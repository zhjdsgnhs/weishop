  ...
  <ul>
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/jk1.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">泰昌足浴盆TC-2053</a>
     </h2>
     <p>
      <del>5.90</del>
     </p>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/jk2.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">泰昌足浴盆TC-5211</a>
     </h2>
     <p>
      <del>12.90</del>
     </p>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/jk3.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">泰昌足浴盆TC-5700</a>
     </h2>
     <p>
      <del>9.90</del>
     </p>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/jk4.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">泰昌足浴盆TC-2057</a>
     </h2>
     <p>
      <del>9.90</del>
     </p>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/jk5.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">泰昌足浴盆TC-5301</a>
     </h2>
     <p>
      <del>9.90</del>
     </p>
