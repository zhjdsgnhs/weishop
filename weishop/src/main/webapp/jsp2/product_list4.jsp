        ...
        <ul>
            <li>
                <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
                    <img src="${ctx}/statics/qiantai/upload/productlist/g11.jpg" />
                </a>
                <div class="goodsInfor">
                    <h2>
                        <a href="${ctx}/jsp2/product.jsp">SKG喷雾仪3186</a>
                    </h2>
                    <p>
                        <del>5.90</del>
                    </p>
            ...
            <li>
                <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
                    <img src="${ctx}/statics/qiantai/upload/productlist/g22.jpg" />
                </a>
                <div class="goodsInfor">
                    <h2>
                        <a href="${ctx}/jsp2/product.jsp">罗曼声波电动牙刷S3</a>
                    </h2>
                    <p>
                        <del>12.90</del>
                    </p>
            ...
            <li>
                <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
                    <img src="${ctx}/statics/qiantai/upload/productlist/g33.jpg" />
                </a>
                <div class="goodsInfor">
                    <h2>
                        <a href="${ctx}/jsp2/product.jsp">罗曼声波电动牙刷T5</a>
                    </h2>
                    <p>
                        <del>9.90</del>
                    </p>
            ...
            <li>
                <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
                    <img src="${ctx}/statics/qiantai/upload/productlist/g44.jpg" />
                </a>
                <div class="goodsInfor">
                    <h2>
                        <a href="${ctx}/jsp2/product.jsp">罗曼声波电动牙刷ST-8872</a>
                    </h2>
                    <p>
                        <del>9.90</del>
                    </p>
            ...
            <li>
                <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
                    <img src="${ctx}/statics/qiantai/upload/productlist/g55.jpg" />
                </a>
                <div class="goodsInfor">
                    <h2>
                        <a href="${ctx}/jsp2/product.jsp">朵莉姿敏保湿润肤洁面乳    90g</a>
                    </h2>
                    <p>
                        <del>9.90</del>
                    </p>
