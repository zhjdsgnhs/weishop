  ...
  <ul>
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/gg1.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">杯具熊 BEDDYBEAR 儿童保温杯带吸管水壶便携不锈钢杯子升级版</a>
     </h2>
     <p>
      <del>5.90</del>
     </p>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/gg2.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">杯具熊 BEDDYBEAR保温杯焖粥杯学生水壶水杯男女情侣杯子多款式</a>
     </h2>
     <p>
      <del>12.90</del>
     </p>
