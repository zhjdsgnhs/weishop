  ...
  <ul>
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/gd1.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">大凉山乌金猪  鲜肉 598套餐（猪蹄2份，腿肉4份，瘦肉2份，脊骨2份，肥肉丁1份）</a>
     </h2>
     <p>
      <del>5.90</del>
     </p>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/gd2.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">大凉山乌金猪  鲜肉 398套餐（猪蹄1份，腿肉2份，瘦肉1份，脊骨1份，肉馅1份，肥肉丁1份）</a>
     </h2>
     <p>
      <del>12.90</del>
     </p>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/gd3.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">大凉山乌金猪  腊肉 598套餐（腊肉3份，广味腊肠2份，川味腊肠2份）</a>
     </h2>
     <p>
      <del>9.90</del>
     </p>
   ...
   <li>
    <a href="${ctx}/jsp2/product.jsp" class="goodsPic">
        <img src="${ctx}/statics/qiantai/upload/productlist/gd4.jpg" />
    </a>
    <div class="goodsInfor">
     <h2>
      <a href="${ctx}/jsp2/product.jsp">大凉山乌金猪  腊肉 498套餐（腊肉2份，广味腊肠2份，川味腊肠2份）</a>
     </h2>
     <p>
      <del>9.90</del>
     </p>
